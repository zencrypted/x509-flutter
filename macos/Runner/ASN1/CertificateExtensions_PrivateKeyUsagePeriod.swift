...
@usableFromInline struct CertificateExtensions_PrivateKeyUsagePeriod: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return CertificateExtensions_PrivateKeyUsagePeriod(notBefore: notBefore, notAfter: notAfter)
        }
    }
