...
@usableFromInline struct ANSI_X9_42_ALGORITHM_ID: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return ANSI_X9_42_ALGORITHM_ID(algorithm: algorithm, parameters: parameters)
        }
    }
