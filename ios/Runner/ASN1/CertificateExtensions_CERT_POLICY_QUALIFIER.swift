...
@usableFromInline struct CertificateExtensions_CERT_POLICY_QUALIFIER: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return CertificateExtensions_CERT_POLICY_QUALIFIER(algorithm: algorithm, parameters: parameters)
        }
    }
