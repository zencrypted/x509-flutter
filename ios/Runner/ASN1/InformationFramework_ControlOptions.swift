...
@usableFromInline struct InformationFramework_ControlOptions: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            let serviceControls: DirectoryAbstractService_ServiceControlOptions? = try DER.optionalExplicitlyTagged(&nodes, tagNumber: 0, tagClass: .contextSpecific) { node in return try DirectoryAbstractService_ServiceControlOptions(derEncoded: node) }
            let searchOptions: DirectoryAbstractService_SearchControlOptions? = try DER.optionalExplicitlyTagged(&nodes, tagNumber: 1, tagClass: .contextSpecific) { node in return try DirectoryAbstractService_SearchControlOptions(derEncoded: node) }
