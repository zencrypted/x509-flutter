...
@usableFromInline struct AlgorithmInformation_2009_SMIME_CAPS: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return AlgorithmInformation_2009_SMIME_CAPS(algorithm: algorithm, parameters: parameters)
        }
    }
