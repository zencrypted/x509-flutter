...
@usableFromInline struct ANSI_X9_42_SubjectPublicKeyInfo: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return ANSI_X9_42_SubjectPublicKeyInfo(algorithm: algorithm, subjectPublicKey: subjectPublicKey)
        }
    }
