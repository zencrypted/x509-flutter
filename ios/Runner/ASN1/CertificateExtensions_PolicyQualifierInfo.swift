...
@usableFromInline struct CertificateExtensions_PolicyQualifierInfo: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return CertificateExtensions_PolicyQualifierInfo(policyQualifierId: policyQualifierId, qualifier: qualifier)
        }
    }
