...
@usableFromInline struct AlgorithmInformation_2009_KEY_AGREE: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            return AlgorithmInformation_2009_KEY_AGREE(algorithm: algorithm, parameters: parameters)
        }
    }
