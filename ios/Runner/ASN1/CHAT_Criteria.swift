...
public struct CHAT_Criteria: DERImplicitlyTaggable, Sendable, RawRepresentable {
    ...
    static let equal = Self(rawValue: 0)
    static let not_equal = Self(rawValue: 1)
    static let like = Self(rawValue: 2)
}
